...
{
	#region AbsenceRecording

	/// <summary>
	/// AbsenceRecording object for NHibernate mapped table 'AbsenceRecording'.
	/// </summary>
	[Serializable]
    public class AbsenceTimeRecording : BaseEntity, Baumax.Contract.IEmployeeTimeRange
		{
		...
		public AbsenceTimeRecording() { }

		public AbsenceTimeRecording( short begin, short end, short time, long absence, long employeeID )
		{
			this._begin = begin;
			this._end = end;
			this._time = time;
			this._absenceID = absence;
