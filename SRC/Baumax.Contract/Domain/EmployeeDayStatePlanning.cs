...
namespace Baumax.Domain
{
    ...
    #region EmployeeDayStatePlanning

    /// <summary>
    /// EmployeeDayStatePlanning object for NHibernate mapped table 'EmployeeDayStatePlanning'.
    /// </summary>
    [Serializable]
    public class EmployeeDayStatePlanning : BaseEntity, IEmployeeDay
    {
        ...
        public EmployeeDayStatePlanning()
        {
        }

        public EmployeeDayStatePlanning(DateTime date, int allreadyPlannedHours, int sumOfAddHours, int plusMinusHours,
