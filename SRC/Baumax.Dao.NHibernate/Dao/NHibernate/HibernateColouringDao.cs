...
{
    public class HibernateColouringDao : HibernateDao<Colouring>, IColouringDao
    {
                                                                      ...
                                                                      bool bForReading, out string filterHQL, User user)
        {
            ...
            sFrom.AppendFormat("SELECT filtered.ID FROM {0} filtered", typeof (Colouring).Name);
        ...
        #region IColouringDao Members

        public IList GetCountryColouring(long countryID)
        {
