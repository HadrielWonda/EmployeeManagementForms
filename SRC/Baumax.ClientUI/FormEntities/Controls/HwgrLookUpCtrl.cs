...
{
    public class HwgrLookUpCtrl : LookUpEdit
    {
        public HwgrLookUpCtrl()
        {
        ...
        private void InitControl()
        {
            if (Properties.Columns.Count != 1)
            {
                ...
                new DevExpress.XtraEditors.Controls.LookUpColumnInfo("Name", "Hwgr", 50, DevExpress.Utils.FormatType.None, "", true, DevExpress.Utils.HorzAlignment.Default, DevExpress.Data.ColumnSortOrder.None)});
        ...
        private List<Domain.HWGR> m_EntityList = null;

        public List<Domain.HWGR> EntityList
        {
            get
            {
                return m_EntityList;
        ...
        public Domain.HWGR CurrentEntity
        {
            get
            {
                long lid = CurrentId;
